...
echo " "
echo "$ADJ1 loved to $VERB1 $ADV1 until one day, there was a $NOUN2 named $ADJ3."
echo " "
echo "$ADJ3 was a mean $NOUN2, who made fun of the way that $ADJ1 would $VERB1."
echo " "
echo "$ADJ3 preffered to $VERB2, and $ADJ3 did so very $ADV2."
echo " "
echo "Fortunately, one day $ADJ1 and $ADJ3 figured out they both liked to $VERB3, and they lived happily ever after."
echo " "
